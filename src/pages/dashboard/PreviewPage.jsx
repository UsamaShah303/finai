...
export default function PreviewPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto animate-fade-in">
      ...
      {/* ── Hero ── */}
      <div className="glass-card p-6 mb-6 relative overflow-hidden" style={{ borderColor: data ? `${data.color}30` : undefined }}>
        {data && (
          <div
      ...
      {/* ── Return range + ESG ── */}
      {loading ? (
        <div className="glass-card p-5 mb-6 grid sm:grid-cols-2 gap-5">
          <Skeleton className="h-16" />
          <Skeleton className="h-16" />
        </div>
      ) : (
        <div className="glass-card p-5 mb-6 grid sm:grid-cols-2 gap-6">
          {/* Return range */}
          <div>
