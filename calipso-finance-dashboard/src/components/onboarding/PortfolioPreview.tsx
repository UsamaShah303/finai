...
export const PortfolioPreview: React.FC<PortfolioPreviewProps> = ({ riskProfile, onConfirm, onRetake }) => {
  ...
  useEffect(() => {
    const fetchPreview = async () => {
      try {
        const result = await authApi.optimizePortfolio(1000, riskProfile.score);
        setData(result);
      } catch (err: any) {
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
           <div className="bg-white/60 p-8 rounded-[40px] border border-white/80">
              ...
              <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Proj. Annual Return</h3>
           ...
           <div className="bg-white/60 p-8 rounded-[40px] border border-white/80">
              ...
              <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">ESG Impact Score</h3>
           ...
           <div className="bg-white/60 p-8 rounded-[40px] border border-white/80">
              ...
              <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Investor Class</h3>
        ...
        <div className="space-y-4 mb-16">
          <h3 className="text-xs font-black text-gray-400 uppercase tracking-widest ml-4 mb-6">Asset Breakdown</h3>
          {data.holdings.map((asset, idx) => (
            ...
            >
              <div className="flex items-center gap-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <span className="text-[10px] font-black px-2 py-0.5 bg-gray-100 rounded-lg text-gray-400 uppercase tracking-tighter">{asset.category}</span>
                  </div>
              ...
              <div className="flex items-center gap-8 md:text-right">
                <div>
                  <span className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Weight</span>
                  <span className="text-lg font-black text-gray-900">{(asset.weight * 100).toFixed(0)}%</span>
                </div>
                <div className="w-32">
                   <span className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Value</span>
