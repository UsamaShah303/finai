      ...
      <div className="flex-1">
        <div className="flex justify-between items-center mb-1">
          ...
          <div className="flex flex-col items-end leading-none">
            ...
            <span className="text-xs text-gray-400 font-bold mt-0.5">{goal.amount}</span>
          </div>
        </div>
    ...
    >
      ...
      <div className="relative w-24 h-24 shrink-0 z-10">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pt-2">
          ...
          <span className="text-xs font-black text-gray-400 uppercase tracking-tighter mt-0.5">Index</span>
        </div>
      </div>
      <div className="flex-1 z-10">
        <div className="flex items-center gap-2 mb-1.5">
          <div className="w-2 h-2 bg-lime-400 rounded-full animate-pulse" />
          <h4 className="text-xs font-black text-gray-400 uppercase tracking-widest">Market Sentiment</h4>
        </div>
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <h5 className="text-xs font-black text-gray-400 uppercase tracking-widest">In-Depth Explanation</h5>
    ...
    <div className="flex-1 flex flex-col gap-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white/60 p-8 rounded-[40px] border border-white/40 shadow-sm">
          <p className="text-gray-400 text-sm font-black uppercase tracking-widest mb-2">Total Goal Volume</p>
        ...
        <div className="bg-white/60 p-8 rounded-[40px] border border-white/40 shadow-sm">
          <p className="text-gray-400 text-sm font-black uppercase tracking-widest mb-2">Completed Goals</p>
        ...
        <div className="bg-white/60 p-8 rounded-[40px] border border-white/40 shadow-sm">
          <p className="text-gray-400 text-sm font-black uppercase tracking-widest mb-2">Average Progress</p>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-center mb-3">
                       ...
                       <span className="text-sm font-black text-gray-400">{goal.amount}</span>
                    </div>
                    <div className="flex items-center gap-4">
                  ...
                  <button className="w-10 h-10 rounded-full bg-gray-50 text-gray-400 flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-all">
                     <ArrowUpRight className="w-5 h-5" />
                  </button>
                </motion.div>
             ))}
...
const AssetRow: React.FC<{ h: Asset, isInternational?: boolean, hasLossOpportunity?: boolean }> = ({ h, isInternational, hasLossOpportunity }) => (
  ...
  >
    ...
    <div className="flex-1 min-w-0">
      ...
      <div className="text-xs text-gray-400 font-medium truncate">{h.name}</div>
    </div>
          ...
          <div className="max-w-xl">
             <div className="flex items-center gap-3 mb-8">
                ...
                <div className="flex flex-col">
                   <span className="text-xs font-black uppercase text-gray-400 tracking-[0.2em]">Live Assets</span>
             ...
             <div className="flex flex-wrap gap-4">
                <div className="glass-pill px-6 py-4 rounded-3xl flex items-center gap-4 border-white/5 hover:border-white/10 transition-colors">
                   ...
                   <div className="flex flex-col">
                      <span className="text-xs text-gray-400 font-black uppercase tracking-widest">Growth</span>
                ...
                <div className="glass-pill px-6 py-4 rounded-3xl flex items-center gap-4 border-white/5">
                   ...
                   <div className="flex flex-col">
                      <span className="text-xs text-gray-400 font-black uppercase tracking-widest">FX Edge</span>
                 ...
                 <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-4">
                       ...
                       <div>
                          ...
                          <p className="text-xs font-black text-gray-400 uppercase tracking-widest">NYSE • NASDAQ</p>
                       </div>
                    </div>
                 </div>
                 ...
                 <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-4">
                       ...
                       <div>
                          ...
                          <p className="text-xs font-black text-gray-400 uppercase tracking-widest">PSX • MUTUAL FUNDS</p>
                       </div>
                    </div>
                 </div>
                 <div className="space-y-1">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                 ...
                 <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2">
                       ...
                       <span className="text-xs font-black text-gray-400 uppercase tracking-widest">You</span>
                    </div>
                    <div className="flex items-center gap-2">
                 ...
                 <div className="space-y-6">
                    ...
                    {simulated && (
                       ...
                       >
                          ...
                          <div>
                             <div className="text-xs font-black text-gray-400 uppercase tracking-widest">Tax Efficiency</div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
        <div className="bg-white/60 rounded-[48px] p-10 border border-white/40 shadow-sm">
           ...
           <div className="mt-12 pt-8 border-t border-gray-100 flex items-center justify-between">
              <div className="flex flex-col">
                <span className="text-xs font-black text-gray-400 uppercase tracking-widest">Last Analyzed</span>
                 ...
                 {NEWS.map((item, idx) => (
                    <motion.div key={idx} whileHover={{ x: 5 }} className="group cursor-pointer">
                       <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className="text-xs font-bold text-gray-400 uppercase tracking-tight">{item.source} • {item.date}</span>
                       </div>
      ...
      <div className="flex items-center justify-between mb-10">
        <div className="flex items-center gap-3">
           ...
           <div className="w-8 h-8 rounded-full border border-gray-100 flex items-center justify-center cursor-help group/info hover:bg-gray-50 transition-colors">
             <Info className="w-4 h-4 text-gray-300 group-hover/info:text-gray-400" />
           </div>
        </div>
        <div className="flex items-center gap-6">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12">
        <div className="relative w-72 h-72 shrink-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
             ...
             <span id="asset-total-label" className="text-xs text-gray-400 font-black tracking-[0.2em] uppercase mt-2">Total</span>
          </div>
        </div>
    ...
    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-8">
      ...
      <div className="flex-1">
        ...
        >
          ...
          <p className="text-lg text-gray-400 font-medium max-w-sm leading-relaxed">
...
const DashboardContent = ({ currentTheme, onOpenDeposit }: { currentTheme: Theme, onOpenDeposit: () => void }) => {
  const { user } = useAuthStore();
  const portfolioValue = ((user?.wallet?.balance_usd || 0) + (user?.wallet?.balance_pkr || 0) / 280);
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        ...
        <div className="xl:col-span-4 bg-white/80 backdrop-blur-xl rounded-[40px] p-8 border border-white shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all group">
          <div className="flex justify-between items-start mb-10">
            <div className="flex flex-col">
              <span className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-1">Portfolio Value</span>
        ...
        <div className="xl:col-span-4 bg-white/80 backdrop-blur-xl rounded-[40px] p-8 border border-white shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all group">
          <div className="flex justify-between items-start mb-10">
            <div className="flex flex-col">
              <span className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-1">Efficiency Score</span>
              ...
              <div className="bg-white/80 backdrop-blur-xl rounded-[40px] p-8 border border-white flex flex-col h-[420px] shadow-sm">
                <div className="flex items-center justify-between mb-8">
                  <div>
                    ...
                    <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-1 block tracking-[0.1em]">Savings Progress</span>
                  </div>
                  <button className="w-8 h-8 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400 hover:text-primary transition-colors">
                    <Plus className="w-4 h-4" />
                  </button>
                </div>
                ...
                <button className="mt-8 w-full py-4 bg-gray-50 rounded-2xl text-[10px] font-black text-gray-400 uppercase tracking-widest hover:bg-primary hover:text-white transition-all">
                  Manage Goals
                </button>
              </div>
              <MarketSentimentCard />
...
const SmartLossStrategyPage = () => {
  ...
  const fetchOpportunities = async () => {
    try {
      const res = await axios.get('/api/tax-loss/opportunities');
    ...
    <div className="flex-1 max-w-7xl mx-auto w-full py-8 px-4">
      <header className="mb-20 flex flex-col md:flex-row items-end justify-between gap-8 border-b border-gray-100 pb-12">
        ...
        <div className="flex flex-col items-end gap-2">
           <span className="text-xs font-black text-gray-400 uppercase tracking-widest">Regulatory Framework</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
        <div className="lg:col-span-8 flex flex-col gap-12">
          <div className="flex items-center justify-between">
            <h2 className="text-xs font-black text-gray-400 uppercase tracking-[0.3em]">Strategy Signals</h2>
          ...
          {opportunities.length === 0 ? (
            <div className="group relative overflow-hidden">
               ...
               <div className="relative py-32 bg-white/40 backdrop-blur-sm rounded-[64px] border border-gray-100 text-center flex flex-col items-center shadow-sm">
                  ...
                  <p className="text-gray-400 font-medium text-base max-w-sm mx-auto leading-relaxed">
        ...
        <aside className="lg:col-span-4 flex flex-col gap-12">
           ...
           <div className="p-10 border border-gray-100 bg-white rounded-[48px] flex flex-col items-center text-center gap-8 shadow-sm hover:shadow-md transition-shadow">
              <div className="w-16 h-16 bg-gray-50 rounded-3xl flex items-center justify-center text-gray-400 transition-colors hover:text-indigo-600">
              ...
              <button className="text-xs font-black text-gray-400 uppercase tracking-[0.3em] hover:text-indigo-600 transition-colors border-t border-gray-50 pt-6 w-full">
...
export default function App() {
  ...
  const { user, token, logout, updateUser, setAuth } = useAuthStore();
        ...
        return (
          <div className="flex-1 flex items-center justify-center p-20">
             <div className="text-center p-20 bg-white/40 backdrop-blur-xl rounded-[60px] border border-white">
                ...
                <p className="text-gray-400 font-medium text-lg">This section is being synchronized with our prediction engine.</p>
             </div>
          </div>
        );
    }
  ...
  return (
    <div className="min-h-screen w-full bg-mesh flex items-center justify-center p-6 lg:p-12 font-sans overflow-hidden relative">
      ...
      >
        ...
        >
          ...
          <div className={`mt-8 pt-6 border-t border-white/10 ${isCollapsed ? 'px-0 flex justify-center' : 'px-8'}`}>
            <button className="flex items-center gap-3 group">
              <div className="w-10 h-10 rounded-full border-2 border-white shadow-md overflow-hidden transition-transform group-hover:scale-110 shrink-0">
                 <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&h=200&fit=crop" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
              </div>
              {!isCollapsed && (
                <motion.div 
                  initial={{ opacity: 0, x: -10 }}
                ...
                >
                   <span className="text-sm font-black text-gray-900">Mr. Smith</span>
                   <span className="text-xs font-bold text-gray-400">Pro Plan</span>
                </motion.div>
              )}
            </button>
          </div>
        ...
        <div className="flex-1 p-8 md:p-12 flex flex-col gap-10 overflow-y-auto scrollbar-hide">
          ...
          <header className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col">
               <h2 className="text-sm font-bold text-gray-400 uppercase tracking-widest">{activeTab === 'Dashboard' ? 'Dashboard Overview' : activeTab}</h2>
               <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown className={`w-3.5 h-3.5 text-gray-400 transition-transform duration-300 ${isThemeOpen ? 'rotate-180' : ''}`} />
                </button>
                        ...
                        {THEMES.map(theme => (
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start leading-tight">
                               ...
                               <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Interface Theme</span>
                            </div>
