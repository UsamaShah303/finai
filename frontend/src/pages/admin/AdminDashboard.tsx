...
const KPICard: React.FC<{ stat: any }> = ({ stat }) => {
  ...
  return (
    ...
    >
      ...
      <div>
        <p className="text-gray-500 dark:text-gray-400 text-[10px] font-black uppercase tracking-[0.2em] mb-2">{stat.label}</p>
        ...
        <div className="xl:col-span-8 bg-white dark:bg-white/5 rounded-[48px] p-10 border border-gray-100 dark:border-white/5 shadow-xl shadow-gray-200/20 dark:shadow-none flex flex-col gap-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              ...
              <p className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest mt-1">Global User Ingress • 30 Day Window</p>
            </div>
              ...
              {['24h', '7d', '30d', '1y'].map((range) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${
                    range === '30d' ? 'bg-white dark:bg-white/10 text-indigo-600 dark:text-white shadow-sm' : 'text-gray-500 dark:text-gray-400 hover:text-gray-600'
                  }`}
                >
                  {range}
                </button>
