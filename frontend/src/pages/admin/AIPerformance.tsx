        ...
        {[
          ...
          <div key={i} className="bg-white p-6 rounded-[32px] border border-gray-100 shadow-sm flex flex-col gap-4">
            <div className="flex justify-between items-start">
               ...
               <span className={`text-xs font-black px-2 py-0.5 rounded-md ${kpi.c.startsWith('+') ? 'bg-emerald-50 text-emerald-600' : kpi.c.startsWith('-') ? 'bg-rose-50 text-rose-600' : 'bg-gray-50 text-gray-500 dark:text-gray-400'}`}>
                  {kpi.c}
               </span>
            </div>
            <div>
