  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-8">
        ...
        <button className="p-2.5 rounded-xl border border-gray-100 text-gray-500 dark:text-gray-400 hover:bg-gray-50 transition-colors">
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
         <div className="p-4 bg-gray-50/50 rounded-2xl flex flex-col gap-1">
            <span className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest leading-none">Latency</span>
            <span className="text-lg font-black text-gray-900 dark:text-white leading-tight">{api.latency}</span>
         </div>
         <div className="p-4 bg-gray-50/50 rounded-2xl flex flex-col gap-1">
            <span className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest leading-none">Uptime</span>
    ...
    <div className="flex-1 flex flex-col gap-10">
      ...
      <div className="space-y-8">
        <div className="flex items-center justify-between px-2">
           <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-black text-gray-900 dark:text-white tracking-tight">Data Provider Grid</h2>
           </div>
           <div className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          ...
          <button className="h-[340px] border-4 border-dashed border-gray-100 rounded-[40px] flex flex-col items-center justify-center gap-4 group hover:border-indigo-200 hover:bg-indigo-50/20 transition-all">
             <div className="w-16 h-16 rounded-[28px] bg-gray-50 flex items-center justify-center text-gray-500 dark:text-gray-400 group-hover:bg-indigo-100 group-hover:text-indigo-600 transition-all">
                <Globe className="w-8 h-8" />
             </div>
             <div className="flex flex-col items-center">
                <span className="text-sm font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest group-hover:text-indigo-600 transition-colors">Add New Provider</span>
                <span className="text-[10px] font-bold text-gray-500 dark:text-gray-300 uppercase tracking-[0.2em] mt-1">Market Data or OAuth</span>
             </div>
          </button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[40px] p-10 border border-gray-100 shadow-sm flex flex-col gap-10">
         <div className="flex items-center justify-between">
            <div>
               <h2 className="text-xl font-black text-gray-900 dark:text-white tracking-tight">Call Volume (24h)</h2>
               <p className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest mt-1">Aggregated platform-wide API requests</p>
            </div>
            <div className="flex gap-6">
               <div className="flex flex-col items-end">
                  <span className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-1">Total Requests</span>
                  <span className="text-2xl font-black text-indigo-600 uppercase tracking-tight">1.24M</span>
               </div>
               <div className="flex flex-col items-end">
                  <span className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-1">Success Rate</span>
         ...
         <div className="flex items-center gap-10 mt-4 overflow-x-auto pb-4 scrollbar-hide">
            <div className="flex items-center gap-3 shrink-0">
               ...
               <div>
                  <span className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest block mb-1">Cost Efficiency</span>
                  <span className="text-sm font-black text-gray-900 dark:text-white">$0.002 / 1k Calls</span>
               </div>
            </div>
            ...
            <div className="flex items-center gap-3 shrink-0">
               ...
               <div>
                  <span className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest block mb-1">Cache Hit Rate</span>
                  <span className="text-sm font-black text-gray-900 dark:text-white">84.2%</span>
               </div>
            </div>
            <div className="w-[1px] h-10 bg-gray-100 shrink-0" />
            <div className="flex items-center gap-3 shrink-0">
               ...
               <div>
                  <span className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest block mb-1">Rate Limit Buffer</span>
                  <span className="text-sm font-black text-gray-900 dark:text-white">12,400 Reqs</span>
               </div>
            </div>
         </div>
      </div>
