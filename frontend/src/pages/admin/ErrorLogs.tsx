  ...
  return (
    ...
    >
      ...
      <div className="col-span-2">
         <span className="text-[10px] font-black text-gray-500 dark:text-gray-400 font-mono uppercase tracking-widest">{log.timestamp}</span>
      </div>
    ...
    <div className="flex-1 flex flex-col gap-12">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10">
        ...
        <div className="flex gap-4">
          <button className="px-6 py-4 bg-gray-900 text-white dark:bg-white dark:text-black rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl flex items-center gap-3">
      ...
      <div className="flex flex-wrap items-center gap-4 px-2">
            ...
            {['ALL', 'ERROR', 'WARN', 'INFO'].map(lvl => (
               <button 
                 ...
                 className={`px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${
                    filter === lvl ? 'bg-indigo-600 text-white shadow-xl shadow-indigo-600/20' : 'bg-white dark:bg-white/5 text-gray-500 dark:text-gray-400 border border-gray-100 dark:border-white/10 hover:bg-gray-50'
                 }`}
               >
                  {lvl}
               </button>
         ...
         <div className="relative flex-1 max-w-md group">
            <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 dark:text-gray-400 group-focus-within:text-indigo-500 transition-colors" />
            <input 
              type="text" 
      ...
      <div className="bg-white dark:bg-white/5 rounded-[48px] border border-gray-100 dark:border-white/5 shadow-xl shadow-gray-200/20 dark:shadow-none overflow-hidden flex flex-col">
         <div className="grid grid-cols-12 px-10 py-6 bg-gray-50 dark:bg-white/5 border-b border-gray-100 dark:border-white/5">
            <div className="col-span-2 text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-[0.2em]">Severity</div>
            <div className="col-span-2 text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-[0.2em]">Temporal</div>
            <div className="col-span-2 text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-[0.2em]">Module</div>
            <div className="col-span-4 text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-[0.2em]">Message Payload</div>
            <div className="col-span-2 text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-[0.2em] text-right">Origin</div>
         </div>
         ...
         <div className="px-10 py-6 bg-gray-50/50 dark:bg-white/5 flex items-center justify-between border-t border-gray-100 dark:border-white/5">
            <div className="flex items-center gap-4">
               <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-[900] text-gray-500 dark:text-gray-400 uppercase tracking-widest">End of stream</span>
               </div>
               <div className="w-[1px] h-4 bg-gray-200 dark:bg-white/10" />
               <span className="text-[10px] font-[900] text-gray-500 dark:text-gray-400 uppercase tracking-widest">Showing 420 traces</span>
            </div>
            <div className="flex gap-4">
               <button className="p-2.5 bg-white dark:bg-white/5 rounded-xl border border-gray-100 dark:border-white/5 text-gray-500 dark:text-gray-400 hover:text-indigo-600 transition-colors">
